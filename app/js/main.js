...
var figureBody = document.querySelector('.figure__body'),
    ...
    checkboxGecko = document.querySelector('input#css'); // console.log(checkboxCss.checked);

figureBody.addEventListener('input', function (event) {
...
function calculate() {
  ...
  borderInputs.forEach(function (item, number) {
